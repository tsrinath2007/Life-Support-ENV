...
This repository contains Team **BigByte**'s submission for the **Scaler School of Technology Hackathon**. The challenge requires building an AI agent capable of autonomously managing the life support systems of a space habitat — balancing oxygen production, CO₂ removal, water recycling, and food cultivation to sustain a crew across missions of increasing complexity.

The environment models a genuinely closed-loop system: every resource is interconnected, every action carries multi-subsystem consequences, and failure to plan across time horizons results in crew health degradation or mission termination.
...
----------------------------------------------------------------------
task_easy                     0.9976     True       24      20.17
task_medium                   0.8422     True       70      52.22
task_hard                     0.7061     True       77      56.68
----------------------------------------------------------------------
AVERAGE                       0.8486
```
...
This section documents the submission requirements for the Scaler School of Technology Hackathon.

**Team Name:** BigByte

### Submission Checklist

- [ ] Agent code is well-commented and reproducible
- [ ] `results.json` present with scores across all three tasks
- [ ] `APPROACH.md` included (max 1 page) describing the agent strategy
- [ ] Baseline scores are met or exceeded on at least one task
- [ ] Repository link submitted via the Scaler Hackathon portal
...
3. Run the agent:
   ...
   ```
4. Scores will be saved to `results.json`.

> **Note:** All experiments were run with `seed=42` for reproducibility.
...
*Team BigByte · Scaler School of Technology Hackathon · OpenEnv Framework*
